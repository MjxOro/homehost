...
const SELECT_CLASS =
  "min-h-11 max-w-[170px] cursor-pointer appearance-none rounded-full border border-line-strong bg-ink-1 bg-[url(data:image/svg+xml,%3Csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20viewBox=%270%200%2024%2024%27%20fill=%27none%27%20stroke=%27%237e939a%27%20stroke-width=%272%27%20stroke-linecap=%27round%27%20stroke-linejoin=%27round%27%3E%3Cpath%20d=%27m6%209%206%206%206-6%27/%3E%3C/svg%3E)] bg-[position:right_12px_center] bg-[size:16px] bg-no-repeat py-2 pe-[38px] ps-3.5 text-[14px] font-semibold text-text-1 transition-colors enabled:hover:border-text-3 disabled:cursor-wait disabled:opacity-60 sm:max-w-60";
  ...
  return (
    <div className="relative flex items-center gap-2.5">
      ...
      {switchPersona.isError ? (
        <p
          className="absolute right-0 top-[calc(100%+6px)] m-0 max-w-[min(70vw,320px)] text-right text-[12.5px] text-[#f0a8a8]"
          role="alert"
        >
